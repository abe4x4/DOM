// found a cool way to solve order the names problem for DOM ex. 5
// 12:55
// function solve() {
//     var inputName2 = document.getElementsByTagName("input")[0];
//     let addBtnInit = document.getElementById("addBtn");
//     let listItems = document.getElementsByTagName("li");
//     let checkArray = [];
//     addBtnInit.addEventListener("click", () => {
//         //console.log(inputName2 + " input name 2");
//         let inputToConvert = inputName2.value;
//         var inputToConvertFirstCharLowercase = inputToConvert.toLowerCase();
//         var beginsWithCode = inputToConvertFirstCharLowercase.charCodeAt(0);
//         inputName2.value = "";
//         var beginsWithCodeLocationListIndex = beginsWithCode - 97;
//         if (checkArray.includes(listItems[beginsWithCodeLocationListIndex])){
//         listItems[beginsWithCodeLocationListIndex].innerText += `, ${inputToConvert}`;
//         checkArray.push(listItems[beginsWithCodeLocationListIndex]);
//         } else {
//         listItems[beginsWithCodeLocationListIndex].innerText = inputToConvert;
//         checkArray.push(listItems[beginsWithCodeLocationListIndex]);
//         }
